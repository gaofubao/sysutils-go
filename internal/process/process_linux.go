...
import (
	...
	"strconv"
	"strings"
	"sysutils-go/internal/cpu"
	"sysutils-go/internal/net"
...
func (p *Process) ForegroundWithContext(ctx context.Context) (bool, error) {
	...
	pid := p.Pid
	statPath := pkg.HostProc(strconv.Itoa(int(pid)), "stat")
...
func (p *Process) IOniceWithContext(ctx context.Context) (int32, error) {
	return 0, pkg.ErrNotImplementedError
}
...
func (p *Process) ThreadsWithContext(ctx context.Context) (map[int32]*cpu.TimesStat, error) {
	...
	taskPath := pkg.HostProc(strconv.Itoa(int(p.Pid)), "task")
...
func (p *Process) CPUAffinityWithContext(ctx context.Context) ([]int32, error) {
	return nil, pkg.ErrNotImplementedError
}
...
func (p *Process) ChildrenWithContext(ctx context.Context) ([]*Process, error) {
	pids, err := pkg.CallPgrepWithContext(ctx, invoke, p.Pid)
	if err != nil {
...
func (p *Process) NetIOCountersWithContext(ctx context.Context, pernic bool) ([]net.IOCountersStat, error) {
	filename := pkg.HostProc(strconv.Itoa(int(p.Pid)), "net/dev")
...
func (p *Process) MemoryMapsWithContext(ctx context.Context, grouped bool) (*[]MemoryMapsStat, error) {
	...
	smapsPath := pkg.HostProc(strconv.Itoa(int(pid)), "smaps")
...
func (p *Process) EnvironWithContext(ctx context.Context) ([]string, error) {
	environPath := pkg.HostProc(strconv.Itoa(int(p.Pid)), "environ")
...
func (p *Process) fillFromLimitsWithContext(ctx context.Context) ([]RlimitStat, error) {
	pid := p.Pid
	limitsFile := pkg.HostProc(strconv.Itoa(int(pid)), "limits")
...
func (p *Process) fillFromfdListWithContext(ctx context.Context) (string, []string, error) {
	pid := p.Pid
	statPath := pkg.HostProc(strconv.Itoa(int(pid)), "fd")
...
func (p *Process) fillFromCwdWithContext(ctx context.Context) (string, error) {
	pid := p.Pid
	cwdPath := pkg.HostProc(strconv.Itoa(int(pid)), "cwd")
...
func (p *Process) fillFromExeWithContext(ctx context.Context) (string, error) {
	pid := p.Pid
	exePath := pkg.HostProc(strconv.Itoa(int(pid)), "exe")
...
func (p *Process) fillFromCmdlineWithContext(ctx context.Context) (string, error) {
	pid := p.Pid
	cmdPath := pkg.HostProc(strconv.Itoa(int(pid)), "cmdline")
...
func (p *Process) fillFromIOWithContext(ctx context.Context) (*IOCountersStat, error) {
	pid := p.Pid
	ioPath := pkg.HostProc(strconv.Itoa(int(pid)), "io")
...
func (p *Process) fillFromStatmWithContext(ctx context.Context) (*MemoryInfoStat, *MemoryInfoExStat, error) {
	pid := p.Pid
	memPath := pkg.HostProc(strconv.Itoa(int(pid)), "statm")
...
func (p *Process) fillFromTIDStatWithContext(ctx context.Context, tid int32) (uint64, int32, *cpu.TimesStat, int64, uint32, int32, *PageFaultsStat, error) {
	...
	if tid == -1 {
		...
		statPath = pkg.HostProc(strconv.Itoa(int(pid)), "task", strconv.Itoa(int(tid)), "stat")
	}
	...
	bootTime, _ := pkg.BootTimeWithContext(ctx)
...
func pidsWithContext(ctx context.Context) ([]int32, error) {
	return readPidsFromDir(pkg.HostProc())
}
